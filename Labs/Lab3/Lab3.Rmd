...
I chose these 2 queries because I wanted to know if there is any connection between the number of trees in an area and the cancer rate of the population in that same area. Because, back in my home country, Indonesia, a lot of people smoke and the air pollution is really bad, therefore the cancer rate is quite high. Since it's known that planting more trees helps to reduce pollution in the area I wanted to visualize the relationship of these 2 variables. So I used "trees_area" and "CancerRt". My hypothesis was that if there are more trees in an area the cancer rate will be lower in that area. I chose the threshold of 200,000 for trees because it was about the median values for it, and 400 for cancer rate because of the same reason. By plotting both variables in a map, I see a very strong correlation between areas which has a lot of trees and areas who has a lower cancer rate. The relationship is very clear that more trees will lead to lower cancer rate. Therefore, this confirms my hypothesis. This was really interesting because the correlation was very strong and its clear of the positive impacts of planting more trees.
---
